    ...
    for (const azienda of aziendeDaNotificare) {
      const emailRes = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          html: `<div style="font-family:Georgia,serif;padding:32px;background:#f0f2ee;border-radius:12px;max-width:600px;margin:0 auto"><div style="background:#1a2e1a;padding:24px;border-radius:8px;text-align:center;margin-bottom:24px"><h1 style="color:#e9c46a;margin:0">🔔 Nuovo Lavoratore</h1><p style="color:#52b788;margin:8px 0 0">StaffAlpine — Valle d'Aosta</p></div><div style="background:white;padding:24px;border-radius:8px"><p style="color:#1a2e1a">Gentile <strong>${azienda.nome_azienda}</strong>,</p><p style="color:#1a2e1a">Un nuovo lavoratore con mansione <strong>${mansione}</strong> si è registrato e potrebbe essere compatibile con le vostre offerte.</p><div style="text-align:center;margin-top:24px"><a href="https://staffalpine.it/dashboard-azienda.html" style="background:#2d6a4f;color:white;padding:12px 32px;border-radius:8px;text-decoration:none">Vai alla Dashboard →</a></div><div style="text-align:center;margin-top:20px;padding-top:16px;border-top:1px solid #d4d8d0;"><p style="color:#6b705c;font-size:12px;margin:0 0 8px;">StaffAlpine — Valle d'Aosta · <a href="https://staffalpine.it" style="color:#52b788;text-decoration:none;">staffalpine.it</a></p><p style="color:#9aa093;font-size:11px;margin:0;line-height:1.5;">Ricevi questa email perché sei registrato come azienda su StaffAlpine.<br>Per non ricevere più comunicazioni: <a href="mailto:info@staffalpine.it?subject=Disiscrizione%20StaffAlpine&body=Vorrei%20disiscrivermi%20dalle%20comunicazioni%20email%20di%20StaffAlpine." style="color:#9aa093;">disiscriviti</a></p></div></div>`
        })
      });
